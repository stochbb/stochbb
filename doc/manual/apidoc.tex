...
\begin{deffunc}{stochbb::unif}{\class{Var}}{double a, double b}	
Constructs a new uniform-distributed random variable on the interval $[a,b]$, that is $\text{U}[a,b](x)$.
\end{deffunc}

\begin{deffunc}{stochbb::norm}{\class{Var}}{double mu, double sigma}
...
\begin{deffunc*}{stochbb::norm}{\class{Var}}{const \class{Var}\& mu, const \class{Var}\& sigma}
