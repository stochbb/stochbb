...
simple random variable having a specified distribution (\class{AtomicVar}) or a random
...
\begin{tabular}{l|lp{8.4cm}l}
 ...
 \function{stochbb::norm} & \code{mu}, \code{sigma} & A process with a normal-distributed \emph{waiting time}. \\
 ...
 \function{stochbb::studt} & \code{nu} & A process with a Student's t-distributed \emph{waiting time}. \\
\end{tabular}
