...
\marked{TODO: I added the parameter estimation feature only recently, hence it is not mentioned early. Should I put it more into the focus of the paper? I guess that plotting marginal PDFs is nice, but fitting to data is much more important.}